...
export default function AdminSidebar() {
  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-50 w-64 bg-industrial-900 text-white hidden lg:block">
      {/* Logo */}
      <div className="flex items-center gap-3 px-6 py-5 border-b border-industrial-800">
        ...
        <div>
          <div className="font-display font-semibold">Industrial Realty</div>
